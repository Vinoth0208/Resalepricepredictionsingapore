...
def Data():
    ...
    data2 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/blob/26d2b8186719c5101a8e710b055285c1336b49b6/Data/ResaleFlatPricesBasedonApprovalDate2000Feb2012.csv')
    data1 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/blob/26d2b8186719c5101a8e710b055285c1336b49b6/Data/ResaleFlatPricesBasedonApprovalDate19901999.csv')
    data3 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/blob/26d2b8186719c5101a8e710b055285c1336b49b6/Data/ResaleFlatPricesBasedonRegistrationDateFromMar2012toDec2014.csv')
    data4 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/blob/26d2b8186719c5101a8e710b055285c1336b49b6/Data/ResaleFlatPricesBasedonRegistrationDateFromJan2015toDec2016.csv')
    data5 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/blob/26d2b8186719c5101a8e710b055285c1336b49b6/Data/ResaleflatpricesbasedonregistrationdatefromJan2017onwards.csv')
