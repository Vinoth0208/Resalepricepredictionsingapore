...
def Data():
    ...
    data2 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/Data/ResaleFlatPricesBasedonApprovalDate2000Feb2012.csv')
    data1 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/Data/ResaleFlatPricesBasedonApprovalDate19901999.csv')
    data3 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/Data/ResaleFlatPricesBasedonRegistrationDateFromMar2012toDec2014.csv')
    data4 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/Data/ResaleFlatPricesBasedonRegistrationDateFromJan2015toDec2016.csv')
    data5 = pd.read_csv(
        r'https://github.com/Vinoth0208/Resalepricepredictionsingapore/Data/ResaleflatpricesbasedonregistrationdatefromJan2017onwards.csv')
